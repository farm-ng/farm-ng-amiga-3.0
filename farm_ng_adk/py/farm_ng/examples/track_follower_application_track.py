...
async def main(address: str, track: str):
    ...
    try:
        ...
        if coords:
            print(
                f"Current position: Latitude: {coords[-1]['latitude']}, Longitude: {coords[-1]['longitude']}"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to the track to be repeated; This example uses tracks recorded by the Map Recorder application.",
    )
